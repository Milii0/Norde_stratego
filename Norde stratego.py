...
characters = {
    #"Elite Knight":             {"HP": 33, "Speed": 3, "Base Attack": 3, "Special": "Ignores 1 damage per attack", "Heal": 0, "Level": 0},
    #"Master Sorcerer":          {"HP": 21, "Speed": 1, "Base Attack": 4, "Special": "Double damage on 2-5", "Heal": 0, "Level": 0},
    #"Elder Druid":              {"HP": 23, "Speed": 2, "Base Attack": 2, "Special": "Heals 4 HP per turn", "Heal": 4, "Level": 0},
    #"Royal Paladin":            {"HP": 27, "Speed": 4, "Base Attack": 2, "Special": "Heals 1 HP on 1 & 6 rolls", "Heal": 1, "Level": 0},
    "Murloc":                   {"HP": 15, "Speed": 14, "Base Attack": 1, "Special": "Insta Mewtwo", "Heal": 0, "Level": 0, "Vocation": "Pokemon"},
    "Mewtwo":                   {"HP": 45, "Speed": 13, "Base Attack": 10, "Special": "w00000t", "Heal": 0, "Level": 0, "Vocation": "Murloc"},
    "Grim Avatar":              {"HP": 35, "Speed": 11, "Base Attack": 4, "Special": "Strong man", "Heal": 0, "Level": 3, "Vocation": "Elite Knight"},
    "Mystic Avatar":            {"HP": 24, "Speed": 9, "Base Attack": 5, "Special": "Double damage on 2-5", "Heal": 0, "Level": 3, "Vocation": "Master Sorcerer"},
    "Hidedo":                   {"HP": 26, "Speed": 10, "Base Attack": 3, "Special": "Heals 4 HP per turn", "Heal": 4, "Level": 3, "Vocation": "Elder Druid"},
    "Dark Lord Kebab":          {"HP": 30, "Speed": 12, "Base Attack": 3, "Special": "Heals 1 HP on 1 & 6 rolls", "Heal": 1, "Level": 3, "Vocation": "Royal Paladin"},
    "Kapedward":                {"HP": 33, "Speed": 7, "Base Attack": 3, "Special": "Ignores 1 damage per attack", "Heal": 0, "Level": 2, "Vocation": "Elite Knight"},    
    "Kotku":                    {"HP": 21, "Speed": 5, "Base Attack": 4, "Special": "Double damage on 2-5", "Heal": 0, "Level": 2, "Vocation": "Master Sorcerer"},
    "Sun Henceforth":           {"HP": 23, "Speed": 6, "Base Attack": 2, "Special": "Heals 4 HP per turn", "Heal": 4, "Level": 2, "Vocation": "Elder Druid"},
    "Malcolm Eks":              {"HP": 27, "Speed": 8, "Base Attack": 2, "Special": "Heals 1 HP on 1 & 6 rolls", "Heal": 1, "Level": 2, "Vocation": "Royal Paladin"},
    "Miu sa":                   {"HP": 28, "Speed": 3, "Base Attack": 2, "Special": "Ignores 1 damage per attack", "Heal": 0, "Level": 1, "Vocation": "Elite Knight"},
    "Marco the Dragon Knight":  {"HP": 19, "Speed": 1, "Base Attack": 3, "Special": "Double damage on 2-5", "Heal": 0, "Level": 1, "Vocation": "Master Sorcerer"},
    "Moster Myrna":             {"HP": 20, "Speed": 2, "Base Attack": 1, "Special": "Heals 4 HP per turn", "Heal": 4, "Level": 1, "Vocation": "Elder Druid"},
    "Nakai":                    {"HP": 24, "Speed": 4, "Base Attack": 1, "Special": "Heals 1 HP on 1 & 6 rolls", "Heal": 1, "Level": 1, "Vocation": "Royal Paladin"},
...
addons = {
    ...
    "The Unstoppable Force": {"HP": 0, "Speed": 0, "Base Attack": 0, "Special": "Neutralize ImmObject", "Heal": 0},
    "Rhok'delar": {"HP": 2, "Speed": 0, "Base Attack": 0, "Special": "6 to 8 kites", "Heal": 0},
    "Frostmourne": {"HP": 0, "Speed": 0, "Base Attack": 0, "Special": "1 freezes", "Heal": 0},
    "Defias Bandana": {"HP": 0, "Speed": 0, "Base Attack": 0, "Special": "No damage taken on 4, 6", "Heal": 0},
    "Cloak of Shadow": {"HP": 0, "Speed": 0, "Base Attack": 0, "Special": "Vanish", "Heal": 0},
    "Boots of Haste": {"HP": 0, "Speed": 0, "Base Attack": 0, "Special": "Change speed to 7", "Heal": 0},
    "Grand Marshals Claymore": {"HP": 0, "Speed": 0, "Base Attack": 0, "Special": "Big D", "Heal": 0},
    "Hand of Ragnaros": {"HP": 0, "Speed": 0, "Base Attack": 0, "Special": "1,3,6 hurl fireball. 3 damage to attacker", "Heal": 0},
    "Rocket Helmet": {"HP": 0, "Speed": 0, "Base Attack": 0, "Special": "Reduce opponents health to 17", "Heal": 0},
}
...
def calculate_healing(roll, character, heal, vocation): #add weapon?
    healing = 0

    if vocation == "Elder Druid":#character[:-1] == "Elder Druid":
        healing += heal
    if vocation == "Royal Paladin" and (roll[0] in (1, 6)):
        healing += heal
    if vocation == "Royal Paladin" and (roll[1] in (1, 6)):
        healing += heal
    
    return healing

def calculate_damage(roll, character, character_name, attack_item, defend_item, vocation):
    skip = False
    HP_change = 0
    ...
    if "The Immovable Object" in defend_item and vocation in ["Elite Knight", "Royal Paladin"]:
...
if "battle_log" not in st.session_state:
    ...
    if "Boots of Haste" in st.session_state.fighter1_item:
        st.session_state.fighter1["Speed"] = 16
    if "Boots of Haste" in st.session_state.fighter2_item:
        st.session_state.fighter2["Speed"] = 16
...
if st.button("Roll Dice for Current Turn"):
    ...
    if st.session_state.turn == "first":
        ...
        st.markdown(f"# {roll1}")
        damage1, skip_turn, HP_modifier = calculate_damage(roll1, st.session_state.first, st.session_state.first_name, st.session_state.first_item, st.session_state.second_item, st.session_state.first["Vocation"])
        ...
        healing1 = calculate_healing(roll1, st.session_state.first_name, st.session_state.first["Heal"], st.session_state.first["Vocation"])
        ...
        damage2, skip_turn, HP_modifier = calculate_damage(roll2, st.session_state.second, st.session_state.second_name, st.session_state.second_item, st.session_state.first_item, st.session_state.second["Vocation"])
        st.markdown(f"# {roll2}")
        ...
        # Apply healing for fighters with healing abilities
        healing2 = calculate_healing(roll2, st.session_state.second_name, st.session_state.second["Heal"], st.session_state.second["Vocation"])
